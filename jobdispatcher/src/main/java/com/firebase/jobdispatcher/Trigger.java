 ...
 *
 * <p>More specifically, a Trigger is an opaque, abstract class used to root the type hierarchy.
 */
public final class Trigger {

  /**
   * Immediate is a Trigger that's immediately available. The Job will be run as soon as the runtime
   * constraints are satisfied.
   *
   * <p>It is invalid to schedule an Immediate with a recurring Job.
   */
